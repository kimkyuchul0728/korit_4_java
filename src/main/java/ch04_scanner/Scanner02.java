...
public class Scanner02 {
    public static void main(String[] args) {
        /*
            ...
            .nextLine(0 : String 데이터를 받을 때 띄어쓰기 인정하고 enter 키 기준으로 데이터가 입력됨
...
//        System.out.println("10년 후 나이는 " + (age + 10) + "살 입니다. ");
...
//      System.out.print("주소를 입력하세요 >>> ");
//      address = scanner.nextLine();
//      System.out.println("안녕하세요, 제 이름은 " + name + "입니다. " + address + "에 살고 있습니다. 10년 후 나이는 " + (age + 10) + "살 입니다.");
