...
public class Array02 {
    public static void main(String[] args) {
        ...
        // 그러면 저희 interArr02에다가 다시 값을 재대입할건데,
        // 1 ~ 100까지 대입해보겠습니다.
        for (int i = 0 ; i < intArr02.length ; i++) {
            intArr02[i] = i+1;
            System.out.println(intArr02[i]);
        }

        int total = 0;
        // 이상의 변수를 사용하여 intArr02의 모든 element의 값을 구하시오.
        for (int i = 0 ; i < intArr02.length ; i++) {
            intArr02[i] = i+1;
            total += intArr02[i];
        }
