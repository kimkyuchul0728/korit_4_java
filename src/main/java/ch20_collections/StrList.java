...
public class StrList {
    public static void main(String[] args) {
        ...
        String searchElem2 = "py";      // 하드 코딩을 피하기 위해 변수 대입했습니다.
        ...
        // String의 경우는 char들이 '순서대로' 나열될 것이기 때문에 char 하나가 포함된 것을
        ...
        // element의 일부만 가지고 삭제하는 것이 불가능합니다(일부로 element 전체 삭제 불가능, 또한 removeElem2 = "py"로 했을 때)
