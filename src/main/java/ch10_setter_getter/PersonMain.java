...
public class PersonMain {
    public static void main(String[] args) {
        ...
        // 여기서 이이라는 사람의 이름을 강이로 바꾸고 싶다면 두 가지 방법이 있죠,
        // # 1 객체명.속성명
//        person2.name = "강이";  // Person.java에 privat 적용하면 오류 발생
        // # 2 setName()을 이용하는 방법
        person2.setName("최이");

        // 마찬가지로 콘솔창에 person2의 name을 출력하는 방법도 두 가지입니다.
        // # 1.
//        System.out.println(person2.name);  // Person.java에 privat 적용하면 오류 발생
        // # 2.
        ...
        System.out.println(person1.getName() + " 님 밤갑습니다.");
        System.out.println(person2.getName() + " 님 밤갑습니다.");
