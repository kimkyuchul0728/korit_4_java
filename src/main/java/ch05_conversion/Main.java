...
public class Main {
    public static void main(String[] args) {
        ...
        // 업캐스팅 방법 # 1
        //형변환을 하기 위해서는 '(바꿀데이터타입)변수형'으로 작성하시면 됩니다.
        System.out.println("변형 : " + (int) cast1); // 65가 나중에 문자로 뭔지 물어보는 경우가 있음

        char cast2 = 'a';
        System.out.println("원형 : " + cast2);
        System.out.println("변형 : " + (int) cast2); //소문자의 경우는 대문자만큼은 출제되지 않지만 외워야 될 필요는 있습니다.
        ...
        /*
            ...
            downcasting의 경우에는 데ㅇ터를 축소하는 과정에서 메모리 용량을 벗어나게 되는
            경우가 있습니다. 용량 오버에 해당하는 현상을 미리 점검하기 위해
            다운캐스팅 시에는 명식적(explicit)으로만 변형이 가능합니다.
