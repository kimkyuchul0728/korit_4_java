...
public class TeacherMain {
    public static void main(String[] args) {
        Teacher teacher1 = new Teacher("김규철", "코리아아이티");
        Teacher teacher2 = new Teacher("김규철", "코리아아이티");
        ...
        String name = "김규철";
        boolean result3 = name.equals("김규철");
        System.out.println(result3);        // 결과값 : true
        boolean result4 = name == "김규철";
        System.out.println(result4);        // 결과값 : true

        String name2 = new String("김규철");
